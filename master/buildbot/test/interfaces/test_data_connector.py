...
from buildbot.test.fake import fakemaster, fakedata
...
class Tests(interfaces.InterfaceTests):
    ...
    def test_signature_stopConsuming(self):
        cons = self.data.startConsuming(lambda : None, ('changes',))
        @self.assertArgSpecMatches(cons.stopConsuming)
        def stopConsuming(self):
            pass
    test_signature_stopConsuming.todo = "real implementation doesn't work yet"
